...
class PostComments{
    ...
    newCommentDom(comment){
        ...
        return $(`<li class="list-group-item" id="comment-${ comment._id }">
                    <p class="card-text"> ${ comment.content } </p>
                    <p class="card-text text-muted" style="display: inline;"> ${ comment.user.name } </p>
                    <a class="toggle-like-button" data-likes="0" href="/likes/toggle/?id=${ comment._id}&type=Comment" class="card-link" id="toggle-likes"> 
                        0 Likes
                    </a>
                    <br>
